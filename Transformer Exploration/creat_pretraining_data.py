...
import sys
sys.path.insert(0,'/Users/ankur.kumar/Desktop/Personal/Projects/git projects/transformers-pretraining/models/albert')
...
flags.DEFINE_string("input_file", 'sample.raw.txt',
                    "Input raw text file (or comma-separated list of files).")

flags.DEFINE_string(
    "output_file", 'output/sample.tfrecords',
    "Output TF example file (or comma-separated list of files).")

flags.DEFINE_string(
    "vocab_file", './tokenizer_models/vocab.json',
    "The vocabulary file that the ALBERT model was trained on.")

flags.DEFINE_string("spm_model_file", './tokenizer_models/merges.txt',
...
flags.DEFINE_integer("max_seq_length", 250, "Maximum sequence length.")
...
flags.DEFINE_string("meta_data_file_path", 'output/sample_meta_data',
...
def write_instance_to_example_files(instances, tokenizer, max_seq_length,
  ...
  for (inst_index, instance) in enumerate(instances):
    ...
    masked_lm_ids = [tokenizer.token_to_id(token) for token in instance.masked_lm_labels]
...
def create_training_instances(input_files, tokenizer, max_seq_length,
  ...
  vocab_words = list(json.load(open('./tokenizer_models/vocab.json',)).keys())
  instances = []
